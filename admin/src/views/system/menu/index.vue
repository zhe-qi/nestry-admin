<template>
   <div class="app-container">
      ...
      <el-table v-if="refreshTable" v-loading="loading" :data="menuList" row-key="menuId"
         ...
         <el-table-column prop="menuName" label="菜单名称" :show-overflow-tooltip="true" min-width="150"></el-table-column>
         <el-table-column prop="icon" label="图标" align="center" min-width="150">
            <template #default="scope">
               <svg-icon :icon-class="scope.row.icon" />
            </template>
         </el-table-column>
         <el-table-column prop="orderNum" align="center" label="排序" min-width="150"></el-table-column>
         <el-table-column prop="perms" align="center" label="权限标识" min-width="150"
            :show-overflow-tooltip="true"></el-table-column>
         <el-table-column prop="component" align="center" label="组件路径" min-width="150"
            :show-overflow-tooltip="true"></el-table-column>
         <el-table-column prop="status" align="center" label="状态" min-width="150">
            <template #default="scope">
